...
namespace JosephRueResume.Controllers
{
    public class ReferencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Emailaddress,FirstName,LastName,PhoneNumber,Relationship")] References references)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Emailaddress,FirstName,LastName,PhoneNumber,Relationship")] References references)
        {
            if (id != references.ID)
            {
                return NotFound();
