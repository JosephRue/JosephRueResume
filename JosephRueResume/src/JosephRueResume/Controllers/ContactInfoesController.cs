...
namespace JosephRueResume.Controllers
{
    public class ContactInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var contactInfo = await _context.ContactInfo.SingleOrDefaultAsync(m => m.ID == id);
            if (contactInfo == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,City,FirstName,LastName,PhoneNumber,State,StreetAddress,Zip")] ContactInfo contactInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,City,FirstName,LastName,PhoneNumber,State,StreetAddress,Zip")] ContactInfo contactInfo)
        {
